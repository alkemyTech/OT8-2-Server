...
public class TransactionServiceImpl implements ITransactionService {
    ...
    @Override
    public List<TransactionDto> sendArs(Long userDestinationId, TransactionDto transactionDto, String token) {
        ...
        if (optionalUser.isPresent()) {
            ...
            Optional<Account> optionalAccount = userAccounts.stream()
                    .filter(account -> account.getCurrency().name().equals("ARS"))
                    .findFirst();
        ...
        TransactionDto transactionIncome = createIncome(userDestinationId, transactionDto);
        responseList.add(transactionIncome);
        return responseList;
    }

    @Override
    public TransactionDto createIncome(Long userId, TransactionDto transactionDto) {
